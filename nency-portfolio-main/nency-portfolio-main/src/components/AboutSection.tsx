        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Nency Kalpeshbhai Patel</span>, a B.Tech Computer Science Engineering student (Class of 2028) at Parul University. With over two years of object-oriented programming experience in Java and Python and a strong grounding in data structures, algorithms, and relational databases. Proven ability to design, build, and ship production-style web applications end to end.
            </motion.p>
