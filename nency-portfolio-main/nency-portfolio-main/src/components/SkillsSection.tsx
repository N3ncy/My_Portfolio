...
const bentoCategories = [
  {
    ...
    badge: 'FOUNDATION',
    items: ['Java', 'Python', 'C', 'DSA', 'OOP', 'OS'],
    description: 'Strong foundation in object-oriented programming, data structures, and core computer science principles.',
    stat: 'OOP MASTERY',
  ...
  },
  {
    ...
    badge: 'FRONTEND',
    items: ['HTML', 'CSS', 'JavaScript', 'Backend Scripting'],
    description: 'Building responsive, production-style web applications from end to end.',
    stat: 'RESPONSIVE UI',
  ...
  },
  {
    ...
    badge: 'DATA',
    items: ['SQL', 'Relational DBs', 'DBMS', 'Azure'],
    description: 'Structuring relational data schemas and leveraging Microsoft Azure fundamentals for cloud computing.',
    stat: 'AZURE CERTIFIED',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'TOOLS & SOFT SKILLS',
    badge: 'WORKFLOW',
    items: ['Git', 'GitHub', 'VS Code', 'Agile', 'Problem-Solving'],
    description: 'Efficient version control workflows, time management, and seamless cross-functional team collaboration.',
    stat: 'TEAM ORIENTED',
    colSpan: 'lg:col-span-7',
  },
];
