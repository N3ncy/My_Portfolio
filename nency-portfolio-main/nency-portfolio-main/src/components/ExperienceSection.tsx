...
const journey: RouteStop[] = [
  {
    ...
    description: 'CGPA: 8.48/10. Coursework: Data Structures & Algorithms, OOP, Operating Systems, DBMS, SQL & Computer Networks.',
  },
  {
    id: '02',
    year: '2025',
    title: 'AROGYA AADHAR (MEDIQA)',
    organization: 'DIGITAL HEALTH ID PLATFORM',
    description: 'Designed a centralized medical record system with permission-based sharing. Exhibited platform idea at Tech Expo 2026.',
  },
  {
    id: '03',
    year: '2025',
    title: 'TRAVEL WEBSITE',
    organization: 'RESPONSIVE WEB PROJECT',
    description: 'Developed a fully responsive travel website showcasing destinations using HTML, CSS, and JavaScript. Version control managed via GitHub.',
  },
  {
    id: '04',
    year: '2024 - 2025',
    title: 'HACKATHON PARTICIPATIONS',
    organization: 'PU CODE 3.0 & VADODARA 6.0',
    description: 'Collaborated with cross-functional teams to develop technical prototypes and solve complex problem statements under tight deadlines.',
  },
  {
    id: '05',
    year: '2026',
    title: 'CERTIFICATIONS & AWARDS',
    organization: 'AZURE, SEBI SFF & MORE',
    description: 'Intro to Microsoft Azure and Cloud Computing. SEBI SFF 2026 - Second Round. Nominated for Diwagwr Metha Award 2026.',
  },
];
