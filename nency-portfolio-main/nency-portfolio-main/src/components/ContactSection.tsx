          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-4" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                <a href="mailto:pnency263@gmail.com" className="flex items-center space-x-3 group">
                  <span className="text-[10px] font-mono tracking-widest text-[#8C6D4F] group-hover:text-[#D4AF37] transition-colors">// EMAIL</span>
                  <span className="text-xs text-[#E8DFD8] group-hover:text-white transition-colors">pnency263@gmail.com</span>
                </a>
                <a href="https://linkedin.com/in/nency-patel-420ba735b" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 group">
                  <span className="text-[10px] font-mono tracking-widest text-[#8C6D4F] group-hover:text-[#D4AF37] transition-colors">// LINKEDIN</span>
                  <span className="text-xs text-[#E8DFD8] group-hover:text-white transition-colors">linkedin.com/in/nency-patel-420ba735b</span>
                </a>
                <a href="https://github.com/N3ncy" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 group">
                  <span className="text-[10px] font-mono tracking-widest text-[#8C6D4F] group-hover:text-[#D4AF37] transition-colors">// GITHUB</span>
                  <span className="text-xs text-[#E8DFD8] group-hover:text-white transition-colors">github.com/N3ncy</span>
                </a>
                <div className="flex items-center space-x-3">
                  <span className="text-[10px] font-mono tracking-widest text-[#8C6D4F]">// LOCATION</span>
                  <span className="text-xs text-[#E8DFD8]">Vadodara, Gujarat, India</span>
                </div>
              </div>
            </div>
          </div>
