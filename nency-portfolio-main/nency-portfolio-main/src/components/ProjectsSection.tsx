...
const projects: Project[] = [
  {
    ...
    category: 'DIGITAL HEALTH ID PLATFORM',
    description:
      'Designed a Digital Health ID system enabling secure, centralized medical record management. Built functionality to store prescriptions, lab reports, and patient history in a unified profile. Implemented secure, permission-based record sharing.',
    githubUrl: 'https://github.com/N3ncy',
    tech: [
      'Digital Health',
      'Record Management',
      'Access Control',
    ...
    metrics: [
      { label: 'PLATFORM', value: 'Health ID System' },
      { label: 'SECURITY', value: 'Permission-Based' },
      { label: 'STATUS', value: 'Live: Rural Health Connect AI' },
    ],
  },
  {
    number: '02',
    ...
    description:
      'Developed a fully responsive travel website showcasing destinations, with layouts and navigation tested across devices. Designed interactive UI components to improve usability and managed version control via GitHub.',
    githubUrl: 'https://github.com/N3ncy/travelling-website',
    tech: [
      'HTML',
      'CSS',
      'JavaScript',
    ...
    metrics: [
      { label: 'TYPE', value: 'Frontend Web' },
      { label: 'UI/UX', value: 'Interactive' },
      { label: 'LIVE', value: 'n3ncy.github.io' },
    ],
  },
];
